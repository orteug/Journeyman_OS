...
## Misread 5 — Page Diff Treated as Strategy Change
...
**Calibration:** Before flagging a page diff as a strategic move, isolate the numerical and structural change. Copy changes alone are not signal.
