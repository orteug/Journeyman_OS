...
`generate_digest.py` writes the formatted digest to `digests/digest_latest.md`. The orchestrator (root `CLAUDE.md`) reads this file at every session start and surfaces ACT NOW signals relevant to the active engagement.
